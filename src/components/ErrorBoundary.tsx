          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div className="space-y-3">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3 px-6 bg-gray-100 text-gray-900 rounded-xl font-semibold hover:bg-gray-200 transition-all border border-gray-200"
              >
