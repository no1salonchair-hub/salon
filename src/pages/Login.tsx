...
export const Login: React.FC = () => {
  ...
  const isRegisterMode = searchParams.get('register') === 'true' || searchParams.get('mode') === 'register';
  ...
  if (!isRegisterMode) {
    return (
      <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden relative flex flex-col justify-between selection:bg-purple-600/30 selection:text-purple-300">
        {/* Background Ambitions Glow */}
        <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[600px] sm:w-[900px] h-[600px] bg-purple-600/10 blur-[130px] rounded-full pointer-events-none z-0" />
        <div className="absolute top-[50%] right-[-10%] w-[400px] h-[400px] bg-blue-600/10 blur-[120px] rounded-full pointer-events-none z-0" />

        {/* Back Link and Logo Header */}
        <header className="max-w-7xl w-full mx-auto px-6 h-20 flex items-center justify-between relative z-10 border-b border-white/5">
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-2 text-xs uppercase tracking-widest font-bold text-white/60 hover:text-white transition-all py-2 px-3 hover:bg-white/5 rounded-xl duration-150"
          >
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
            <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-600/20">
              <Scissors className="w-4 h-4 text-white" />
            </div>
            <span className="text-sm font-black tracking-tighter uppercase italic text-white hidden sm:inline-block">
              Salon Chair
            </span>
          </div>
        </header>
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
          <motion.div
            ...
            className="w-full max-w-md bg-neutral-900/60 border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl backdrop-blur-xl relative"
          >
            {/* Header / Intro */}
            <div className="flex flex-col items-center text-center mb-8">
              <div className="w-14 h-14 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-600/20 mb-4">
                <SalonChairIcon className="w-7 h-7 text-white" />
              </div>
              <h2 className="text-2xl font-black bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent italic tracking-tight uppercase">
                Welcome to Salon Chair
              </h2>
              <p className="text-white/50 text-xs font-semibold leading-relaxed mt-3 max-w-xs">
                Sign in with Google to easily book appointments, track your active sessions, and find premium barbers near you.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-4 px-6 bg-white hover:bg-neutral-100 text-black rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl flex items-center justify-center gap-3 transform active:scale-95 duration-150 relative"
              >
                {isSigningIn ? (
              ...
              <button
                ...
                className="w-full py-4 px-6 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 duration-150"
              >
                <Scissors className="w-4 h-4 text-purple-400" />
                <span>Register as Salon Owner</span>
              </button>
            </div>

            {/* Quick Helper Info */}
            <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-center gap-2 text-[10px] uppercase tracking-wider text-white/30 font-bold">
              <ShieldCheck className="w-3.5 h-3.5 text-purple-500" />
              <span>Secure OAuth Auth • No password required</span>
            </div>
          </motion.div>
        </main>
        ...
        <footer className="py-8 border-t border-white/5 bg-black/40 text-center relative z-10">
          <p className="text-white/20 text-[10px] uppercase tracking-widest font-black mb-3">
          ...
          <div className="flex items-center justify-center gap-4 text-white/40 text-[9px] font-black uppercase tracking-widest">
            <span className="hover:text-purple-600 cursor-pointer transition-colors" onClick={() => navigate('/privacy')}>Privacy Policy</span>
            <span>•</span>
            <span className="hover:text-purple-600 cursor-pointer transition-colors" onClick={() => navigate('/contact')}>Contact Support</span>
            <span>•</span>
            <span className="hover:text-purple-600 cursor-pointer transition-colors" onClick={() => navigate('/faqs')}>FAQs</span>
          </div>
        </footer>

        {/* Admin modal stays on active session if needed */}
        <AnimatePresence>
          {showAdminPassword && (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50">
              ...
              >
                <div className="flex flex-col items-center text-center mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg mb-3">
                    <Shield className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-base font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent italic tracking-tight uppercase">
                    Admin Verification
                  </h3>
                </div>
                ...
                <form onSubmit={handleAdminLogin} className="space-y-3">
                  <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-xl">
                    <p className="text-[10px] text-purple-300 font-bold leading-normal text-center">
                      Restricted master admin email session active. Password verification required.
                    </p>
                  </div>
                  ...
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all text-white placeholder:text-white/20 text-sm"
                  />
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    <button
                      ...
                      className="w-full py-3 bg-purple-600 text-white rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-purple-500 transition-all text-center flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2 text-white/40 text-[9px] font-black uppercase tracking-widest hover:text-white transition-colors"
                    >
                      Disconnect admin
                    </button>
                  </div>
